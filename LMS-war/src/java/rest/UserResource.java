...
public class UserResource {
    ...
    public Response createUser(CreateUser createUser) {
        ...
        User existingUser = em.find(User.class, createUser.getUserId());

        try {
            User user = new User();
            user.setFirstName(createUser.getFirstName());
            user.setLastName(createUser.getLastName());
            if (!existingUser.getEmail().equals(createUser.getEmail())) {
                user.setEmail(createUser.getEmail());
            }
            else{
                return Response.status(Response.Status.NOT_ACCEPTABLE).entity("Email already used/exist").build();
            }
    ...
    public Response updateUser(UpdateUser updateUser) {
        ...
        try {
            ...
            if (user != null) {
                ...
                user.setTutorials(updateUser.getTutorials());
