...
public class UpdateAnnoucement {
    ...
    public UpdateAnnoucement(Annoucement annoucement, Long annoucementId, String title, String description, Date createTs, Date updateTs, Boolean systemWide, Module module, User owner) {
