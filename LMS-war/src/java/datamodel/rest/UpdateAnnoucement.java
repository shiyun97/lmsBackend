...
public class UpdateAnnoucement {
    ...
    public UpdateAnnoucement() {
    }

    public UpdateAnnoucement(Annoucement annoucement, Long annoucementId, String title, String content, String createdDate, String lastUpdatedDate, String startDate, String endDate, Boolean publish, Boolean emailNotification, Module module, User owner) {
